...
import com.example.group4_comp304_sec004_lab5.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       // mMap.moveCamera(CameraUpdateFactory.newLatLng(toronto));
        ...
        LatLng rest1 = new LatLng(lat,lng);
        mMap.addMarker(new MarkerOptions().position(rest1).title(RName));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(rest1,17.0f));
